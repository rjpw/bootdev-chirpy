...
- Startup schema gate (builds on [10-schema-version-check.md](10-schema-version-check.md))
...
- **Schema** (private): cached boolean set at startup (from [10-schema-version-check.md](10-schema-version-check.md)). If the schema isn't current, this pod specifically can't serve correct responses.
